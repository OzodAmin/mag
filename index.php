            ...
            <div class="row">
                <div class="col-12">
                    <div class="popular-products-slides">
                        <?php
                            $sql ="SELECT p.name_".$lang.", p.price, c.name_".$lang.", p.image, p.id FROM products p LEFT JOIN categories c ON p.category_id=c.id WHERE p.active=1 ORDER BY p.id DESC LIMIT 4";
